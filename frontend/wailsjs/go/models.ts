export namespace models {
	...
	export class ConnectionWithStatus {
	    name: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new ConnectionWithStatus(source);
	    }
	...
	export class Result___DBDock_models_Column_ {
	    result: Column[];
	    total: number;
	
	    static createFrom(source: any = {}) {
	        return new Result___DBDock_models_Column_(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.result = this.convertValues(source["result"], Column);
	...
	export class SaveDBConnectionResponse {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.connection = this.convertValues(source["connection"], ConnectionWithStatus);
